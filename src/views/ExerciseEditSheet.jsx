    ...
    >
      <div className="sheet">
          ...
          >
            ...
            {nameError ? (
              ...
              <span style={{ fontSize: '0.75rem', color: 'var(--text-secondary)' }}>
                Renaming updates all historical sets automatically
              </span>
            )}
          </div>
          ...
          {MUSCLE_GROUPS.map((muscle) => (
            <div key={muscle} className="muscle-row">
              ...
              <div className="stepper">
                <button className="stepper-btn" onClick={() => step(muscle, -0.25)}>
                  −
                </button>
        ...
        <div className="sheet-footer">
          <button className="btn-primary" onClick={handleSave} disabled={!draftName.trim()}>
            Save
          </button>
        </div>
      </div>
